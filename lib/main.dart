...
import 'package:flutter_deeplinking/path_constant.dart';
import 'package:flutter_deeplinking/profile.dart';
  ...
  Future<void> _createDynamicLink(bool short, String link) async {
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      ...
      androidParameters: const AndroidParameters(
        packageName: 'com.veirn.flutter_deeplinking',
        minimumVersion: 0,
      ),
    );
